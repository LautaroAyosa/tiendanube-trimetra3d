...
<div class="js-reviews-placeholder">
    {% include 'snipplets/reviews/reviews-block.tpl' with {
        ...
        reviews_external_text: 'Ver opiniones en Google',
        ...
        reviews_items: [
            ...
            {
                name: 'Sofia',
                text: 'Compre filamentos para el taller y la respuesta fue muy clara. Me ayudaron a confirmar compatibilidad antes de cerrar el pedido.',
                rating: 5,
                context: 'La Plata - maker independiente',
                verification_type: 'purchase',
                source: 'instagram',
                source_label: 'Instagram',
                date_label: 'Diciembre 2025',
                product_name: 'Filamento PLA',
                product_url: '#',
                highlight: false
            }
        ]
